...
from quad_controller_rl.agents.ddpg import Actor,Critic,ReplayBuffer,OUNoise
    ...
    def step(self, state, reward, done):
        ...
        if done:
            ...
            if (self.episode_num % 20 == 0):
                print("Episode {} ({}): State {:.2f}: Action {:.2f}: Total Reward: {:.0f}".format(self.episode_num,self.count,state[2],action[0][2],self.total_reward))
